...
class UltraRushGoldPlay(StateHelperPlay):
    ...
    state_data: dict = field(init=False, default_factory = lambda: {"Spins": None, "Number of Gold": None, "Ball 1 Val": None, "Ball 2 Val": None, "Ball 3 Val": None, "Ball 4 Val": None, "Ball 5 Val": None})
